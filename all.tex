...
\usepackage[dvips=false,pdftex=true,vtex=false,paperwidth=6.5in,paperheight=6.25in,margin=0.5in,bottom=0.75in,top=0.4in,nohead]{geometry}
\usepackage{floatrow}
...
\begin{figure}
  ...
  \end{figure}
  \begin{figure}
  \ffigbox{\includegraphics[angle=0,width=1.0\textwidth]{008.eps}}%
...
{\includegraphics[scale=1.0]{mass_table.pdf}\hskip4em}
\end{table}

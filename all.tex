...
The subjects were recovered from various asteroids, and are clearly artificial, though their intended use is unknown.
...
The minerals' properties may be categorized as either physical or optical.
...
\begin{table}
\begin{tabular}[crr]
subject & taxonomy & mass & samples \\
001 & labyrinthine ellipsoidal
002 & labyrinthine circular
003 &
004 &
005 &
006 &
...
009 &
\end{tabular}
\caption{\label{tab:mass}\textbf{Although the masses of the subjects varied over time, we were able to record a mean for each subject.} Plots of the mass over time of subject 002 are included in Appendix~A.}
\end{table}
